#!/usr/bin/env python3
"""Deploy AI Company Profile fields + API + migrate."""
...
FILES = [
    "backend/alembic/versions/d1e2f3a4b5c6_business_ai_profile.py",
...
def main() -> int:
    ...
    code = sudo(
        ...
        "curl -sS -o /dev/null -w 'ai_profile_opts:%{http_code}\\n' "
        "-X OPTIONS http://127.0.0.1:8105/api/v1/users/me/business/ai-profile",
        timeout=1800,
    )
    c.close()
    return code
