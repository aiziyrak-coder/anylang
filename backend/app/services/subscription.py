...
FEATURE_TEXTS: dict[str, dict[str, list[tuple[str, bool]]]] = {
    "uz_UZ": {
        ...
        "premium": [
            ...
            ("Kim sizni qidirdi", True),
        ],
        "business": [
            ("Premium'dagi barchasi", True),
            ("AI tarjimon", True),
            ("AI kotib", True),
            ("AI savdo yordamchisi", True),
            ("100 GB fayl", True),
            ("Priority Support", True),
            ("Verified Business Badge", True),
    ...
    "ru_RU": {
        ...
        "premium": [
            ...
            ("Кто смотрел ваш профиль", True),
        ],
        "business": [
            ("Всё из Premium", True),
            ("AI-переводчик", True),
            ("AI-секретарь", True),
            ("AI-помощник по продажам", True),
            ("100 ГБ файлов", True),
            ("Priority Support", True),
            ("Verified Business Badge", True),
    ...
    "us_US": {
        ...
        "premium": [
            ...
            ("Who viewed your profile", True),
        ],
        "business": [
            ("Everything in Premium", True),
            ("AI translator", True),
            ("AI secretary", True),
            ("AI sales assistant", True),
            ("100 GB file storage", True),
            ("Priority Support", True),
            ("Verified Business Badge", True),
